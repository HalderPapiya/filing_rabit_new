        ...
        <div class="app-title">
            <div class="active-wrap">
                ...
                <div class="form-group">
                    <button class="btn btn-primary" type="button" id="btnSave"><i class="fa fa-fw fa-lg fa-check-circle"></i>Update Package</button>
                    <a class="btn btn-secondary" href="{{ route('admin.package.index') }}"><i class="fa fa-fw fa-lg fa fa-angle-left"></i>Back</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <form action="{{ route('admin.package.update') }}" method="POST" role="form" enctype="multipart/form-data" id="form1">
                    ...
                    <div class="tile-body form-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('price') is-invalid @enderror" type="text" name="price" id="price" value="{{ old('price', $data->price) }}"/>
                            <input type="hidden" name="id" value="{{ $data->id }}">
