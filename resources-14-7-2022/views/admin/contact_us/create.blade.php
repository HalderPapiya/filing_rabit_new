...
@section('content')
        ...
        <div class="app-title">
            <div class="active-wrap">
                ...
                <div class="form-group">
                    <button class="btn btn-primary" type="button" id="btnSave"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save Contact Us</button>
                    <a class="btn btn-secondary" href="{{ route('admin.contact-us.index') }}"><i style="vertical-align: baseline;" class="fa fa-chevron-left"></i>Back</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row section-mg row-md-body no-nav">
        <div class="col-md-12 mx-auto">
            <div class="tile">
                <form action="{{ route('admin.contact-us.store') }}" method="POST" role="form" enctype="multipart/form-data" id="form1">
                    @csrf
                    <div class="tile-body form-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('sales_phone') is-invalid @enderror" type="text" name="sales_phone" id="sales_phone" value="{{ old('sales_phone') }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('support_phone') is-invalid @enderror" type="text" name="support_phone" id="support_phone" value="{{ old('support_phone') }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('pinterest_link') is-invalid @enderror" type="text" name="pinterest_link" id="pinterest_link" value="{{ old('pinterest_link') }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('youtube_link') is-invalid @enderror" type="text" name="youtube_link" id="youtube_link" value="{{ old('youtube_link') }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('linkedin_link') is-invalid @enderror" type="text" name="linkedin_link" id="linkedin_link" value="{{ old('linkedin_link') }}"/>
