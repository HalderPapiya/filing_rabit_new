...
@section('content')
        ...
        <div class="app-title">
            <div class="active-wrap">
                ...
                <div class="form-group">
                    <button class="btn btn-primary" type="button" id="btnSave"><i class="fa fa-fw fa-lg fa-check-circle"></i>Update Coupon</button>
                    <a class="btn btn-secondary" href="{{ route('admin.coupon.index') }}"><i class="fa fa-fw fa-lg fa fa-angle-left"></i>Back</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row section-mg row-md-body no-nav">
        <div class="col-md-12 mx-auto">
            <div class="tile">
                <form action="{{ route('admin.coupon.update') }}" method="POST" role="form" enctype="multipart/form-data" id="form1">
                    @csrf
                    <div class="tile-body form-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('coupon_code') is-invalid @enderror" type="text" name="coupon_code" id="coupon_code" value="{{ old('coupon_code', $data->coupon_code) }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('amount') is-invalid @enderror" type="text" name="amount" id="amount" value="{{ old('amount', $data->amount) }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('max_time_of_use') is-invalid @enderror" type="max_time_of_use" name="max_time_of_use" id="max_time_of_use" value="{{ old('max_time_of_use', $data->max_time_of_use) }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('max_time_one_can_use') is-invalid @enderror" type="text" name="max_time_one_can_use" id="max_time_one_can_use" value="{{ old('max_time_one_can_use', $data->max_time_one_can_use) }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('no_of_usage') is-invalid @enderror" type="text" name="no_of_usage" id="no_of_usage" value="{{ old('no_of_usage', $data->no_of_usage) }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('start_date') is-invalid @enderror" type="date" name="start_date" id="start_date" value="{{ old('start_date', $data->start_date) }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('end_date') is-invalid @enderror" type="date" name="end_date" id="end_date" value="{{ old('end_date', $data->end_date) }}"/>
