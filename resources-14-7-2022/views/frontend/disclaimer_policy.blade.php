            ...
            <div class="row">
                <div class="col-12">
                    <div class="section_title">
                        <h2 data-aos="fade-down" data-aos-duration="1000">DISCLAIMER POLICY</h2>
                        <div class="shadow_text">Filingrabbit</div>
                    </div>
                    <a href="{{route('home')}}" class="home">Home</a> / <span>Disclaimer Policy</span>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <ol class="main-ol">
                        @foreach ($disclaimerPolicies as $data)
                        <li>
                            <h3>{{$data->title}}</h3>
                            <p>
                               {!! $data->description !!}
