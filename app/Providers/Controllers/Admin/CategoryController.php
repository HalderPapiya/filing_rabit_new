...
class CategoryController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        return $this->responseRedirect('admin.category.index', 'Category has been added successfully', 'success', false, false);
    }
    ...
    public function edit($id)
    {
        ...
        $this->setPageTitle('Category', 'Edit Category : ' . $category->title);
