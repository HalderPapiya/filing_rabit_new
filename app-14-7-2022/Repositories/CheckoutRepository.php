...
class CheckoutRepository extends BaseRepository implements CheckoutContract
{
    ...
    public function create(array $data)
    {
        ...
        try {
            ...
            $data->fname = $collectedData['email'];
            $data->lname = $collectedData['lname'];
            $data->email = $collectedData['lname'];
            $data->mobile = $collectedData['mobile'];
            $data->billing_country = $collectedData['billing_country'];
            $data->billing_state = $collectedData['billing_state'];
            $data->amount = $collectedData['amount'];
            // $data->qty = 1;
            $data->save();
            ...
            foreach ($cartData as $cartValue) {
                $orderProducts[] = [
                    ...
                    'ip' => $cartValue->ip,
                    'order_no' => $order_no,
                    'fname' => $cartValue->fname,
                    'lname' => $cartValue->lname,
                    'email' => $cartValue->email,
                    'mobile' => $cartValue->mobile,
                    'billing_country' => $cartValue->billing_country,
                    'billing_state' => $cartValue->billing_state,
                    'amount' => $cartValue->amount,
