        ...
        <div class="row ">
            ...
            <div class="col-md-9">
                ...
                <div class="my-account-form-wrapper">
                    <h3>Bid</h3>
                    <form action="{{route('user.add_on_bid.store')}}" method="POST" id="form1">
                        @csrf
                        {{-- <input type="hidden" value="{{$address->id}}" name="id" class="form-control"> --}}
                        <div class="row">
                            <input type="hidden" value="{{$businessAddOn->business_id}}" name="business_id" class="form-control @error('valuation') is-invalid @enderror">
                            <input type="hidden" value="{{$businessAddOn->id}}" name="add_on_id" class="form-control @error('valuation') is-invalid @enderror">
                            <div class="col-12">
