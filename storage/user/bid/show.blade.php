                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="readOnly" name="name" class="form-control @error('name') is-invalid @enderror" value="{{$businessService->name}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="readOnly" name="name" class="form-control @error('name') is-invalid @enderror" value="{{$type->name}}">
                                    @endforeach
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label> Valuation</label>
                                        <input type="readOnly" name="valuation" class="form-control @error('valuation') is-invalid @enderror" value="{{old('valuation', $businessService->valuation) }}">
