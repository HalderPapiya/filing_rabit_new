            ...
            <div class="row">
                <div class="col-12">
                    <div class="section_title">
                        <h2 data-aos="fade-down" data-aos-duration="1000">CONFIDENTIALITY STATEMENT</h2>
                        <div class="shadow_text">Filingrabbit</div>
                    </div>
                    <a href="{{route('home')}}" class="home">Home</a> / <span>Confidentiality Statement</span>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <p>
                        At FilingRabbit, we place a major emphasis on maintaining confidentiality of Client information and Information Security Management. The following are key features of our Confidentiality Agreement, applicable to all our clients.
                    </p>
                    ...
                    <p>
                        2. We do not use our Clients identity or Clients brand for our marketing purposes, without their written consent.
                    </p>
                    <p>
                        3. We never provide our Client’s name or Client’s information to other prospective clients for marketing purposes.
                    </p>
                    <p>
