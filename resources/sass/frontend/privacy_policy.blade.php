            ...
            <div class="row">
                <div class="col-12">
                    <div class="section_title">
                        <h2 data-aos="fade-down" data-aos-duration="1000">PRIVACY POLICY</h2>
                        <div class="shadow_text">Filingrabbit</div>
                    </div>
                    <a href="{{route('home')}}" class="home">Home</a> / <span>PRIVACY POLICY</span>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <ol class="main-ol">
                        ...
                        <li>
                            ...
                            <p>
                                ...
                                dealings with this site,
                            </p>
                            <p>
                                please contact us at: <br>
                                FilingRabbit <br>
                                {{$contact->address}}
                                {{-- 56e, Hemanta Basu Sarani, 2nd floor, Suite #27, Kolkata - 700001, West Bengal, India --}}
                                <br>
                                Phone : +91 9830307515
                            </p>
                            <div>
                                ...
                                <p>Mr. Dipen Lodha</p>
                                <p>+91 9830307515</p>
                                <p>Dipen.lodha@filingrabbit.in</p>
                            </div>
                        </li>
                    </ol>
