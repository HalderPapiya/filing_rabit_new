                    ...
                    <table class="w-100 table table-hover custom-data-table-style table-striped" id="sampleTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Rs.{{ number_format($businessService['valuation']) }}</td>
                                ...
                                <td>
                                    <a href="{{ route('user.business_add_on_by_business.ShowByBusiness',$businessService['id']) }}" style="width: 101px;" class="btn btn-sm btn-primary edit-btn">View Add-ons</i></a>
                                </td>
