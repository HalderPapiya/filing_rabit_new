                        ...
                        <div class="my-account-form-wrapper">
                            ...
                            <form action="{{ route('user.business_add_on.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="add_on_id">Business Add-On Type <span
                                                class="m-l-5 text-danger"> *</span></label>
                                        <select class="form-control @error('add_on_id') is-invalid @enderror"
                                            name="add_on_id" id="add_on_id"
                                            value="{{ old('
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    add_on_id') }}">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="business_id">Business Name <span
                                                class="m-l-5 text-danger"> *</span></label>
                                        <input type="hidden" name="business_id" value="{{ $businessServices[0]['id'] }}">
                                        <input class="form-control bg-transparent" readonly
                                            value="{{ $businessServices[0]['name'] }}">
                                        {{-- @error('type_id')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
