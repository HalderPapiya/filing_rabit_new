        ...
        <div class="row">
            ...
            <div class="col-sm-7 text-center text-sm-right">
                <ul id="menu-topmenu" class="top-menu">
                    <li> <a
                            href="{{ Auth::guard('user')->user() ? route('user.businessService.index') : route('frontend.businessService.index') }}">Business
                        </a>
                    </li>
                    ...
                    @if (Auth()->guard('user')->user())
                        ...
                        <li class="dropdown show">
                            ...
                            <div class="dropdown-menu profile_drop" aria-labelledby="dropdownMenuLink">
                                ...
                                {{-- <a class="dropdown-item" style="{{ request()->is('user/businessService/new*') ? 'background: transparent !important; color: #f1d231 !important; padding-left: 5px !important;' : '' }}" href="{{ route('user.businessService.new') }}">Business Listings</a> --}}
                                <a class="dropdown-item"
