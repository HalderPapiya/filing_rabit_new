        ...
        <div class="row">
            <div class="col-sm-5">
                <ul class="header_contact">
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail">
                    ...
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-phone">
                        ...
                        <div class="sub-menu">
                            <div class="row m-0 h-100">
                                ...
                                <div class="col-md-3 col-sm-6 col-12 mb-4 mb-sm-0">
                                    <a href="{{ route('frontend.product.list', $subcat['id']) }}" class="nav-link">
                                        <h4>{{$subcat->title}}</h4>
                                    </a>
                                    <ul>
