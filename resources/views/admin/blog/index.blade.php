...
@section('content')
    <div class="fixed-row">
        <div class="app-title">
            ...
            <a href="{{ route('admin.blog.create') }}" class="btn btn-primary pull-right"><i class="fa fa-fw fa-lg fa-plus"></i>Add New</a>
        </div>
    </div>
                    ...
                    <table class="table table-hover custom-data-table-style table-striped" id="sampleTable">
                        ...
                        <tbody>
                            @foreach($blogs as $blog)
                                    <tr>
                                      <td><img src="{{URL::to('/').'/uploads/blog/'}}{{$blog->image}}" width="60" /></td>
                                        <td>{{ $blog['title'] }}</td>
                                            ...
                                            <div class="toggle-button-cover margin-auto">
                                                <div class="button-cover">
                                                    <div class="button-togglr b2" id="button-11">
                                                        <input id="toggle-block" type="checkbox" name="status" class="checkbox" data-blog_id="{{ $blog['id'] }}" {{ $blog['status'] == true ? 'checked' : '' }}>
    ...
    <script type="text/javascript">
        $('input[id="toggle-block"]').change(function() {
          ...
          $.ajax({
                ...
                data:{ _token: CSRF_TOKEN, id:blog_id, status:status},
